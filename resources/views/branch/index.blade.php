...
@section('content')
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            <div class="panel-heading">Branches List</div>
            <div class="panel-body">
                ...
                @else
                    <p class="alert alert-warning text-center">There are no branches.</p>
                @endif
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        {!! Form::open(array('route' => 'branch.store', 'class'=>'data-form')) !!}
                        ...
                        <div class="form-group{{ $errors->has('faculty_id') ? ' has-error' : '' }}">
                            {{ Form::label('faculty_id', 'Faculty', ['class'=>'form-label']) }}
